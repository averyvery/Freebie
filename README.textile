...
*A note about using segments in templates:* Due to the way EE is handling Freebie's segments, the bracketless syntax (@{if segment_1 == 'blog'}@) won't work. Instead, you'll need to compare segments more explicitly as strings, like so:
