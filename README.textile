...
Freebie allows you to pick a number of segment names that you want EE to completely ignore when routing. This is really helpful for analytics tracking, throwing "success" messages after forms, and creating "preview" pages to view unpublished entries. When you combine it with "Structure":http://www.buildwithstructure.com, things get CRAZY FUN.

h2. Installation

* Copy /third_party/vl_safesegments into your /system/expressionengine/third_party/ directory.
...
I only made this extension after using Leevi Graham's "NSM Safe Segments":http://github.com/newism/nsm.safe_segments.ee_addon for a loooong time and missing it dearly in EE 2.0. The idea is all Leevi Graham's, and 90% of the implementation is just EE core code copied out and repurposed.
