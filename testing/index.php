...
<html>
  ...
  <body>
    ...
    <div class="settings">
      <div class="setting">
        <p><strong>Freebie segments:</strong></p>
        <pre>
one
two
three
...
*ven
      ...
      <div class="setting">
        <p><strong>Break segments:</strong></p>
        <pre>
break
        </pre>
      </div>
    ...
    <p>Create the following templates/template groups on your EE install. Each template should have only one piece of content, the string listed on the right.</p>
    
    <ul>
      <li>_freebie_test/index -> _freebie_test</li>
      <li>_freebie_test/page -> _freebie_page</li>
    </ul>
